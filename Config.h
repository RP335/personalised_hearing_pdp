...
// AUDIO ENGINE
// ============================================================================
constexpr float SAMPLE_RATE_HZ    = 44100.0f;  // 44.1 kHz — better filter resolution
...
constexpr int   AUDIO_MEM_F32     = 80;         // F32 processing blocks (more for biquad FB)
...
// Bands: [<200] [200-500] [500-1k] [1k-1.5k] [1.5k-2.5k] [2.5k-4k] [4k-6.5k] [>6.5k]
...
constexpr float BAND_CENTERS[N_CHAN] = {
    125.0f, 350.0f, 750.0f, 1250.0f, 2000.0f, 3250.0f, 5250.0f, 7500.0f
};
...
constexpr uint16_t AUDIOGRAM_FREQS[11] = {
